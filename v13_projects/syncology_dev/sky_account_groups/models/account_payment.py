...
class AccountPayment(models.Model):
    ...
    global_id = fields.Char(readonly=True, string='Entry ID', store=True, related='move_id.global_id')
    ...
    def post(self):
        ...
        for rec in self:
            ...
            rec.write({'state': 'posted', 'move_name': move_name, 'global_id': moves.global_id})
