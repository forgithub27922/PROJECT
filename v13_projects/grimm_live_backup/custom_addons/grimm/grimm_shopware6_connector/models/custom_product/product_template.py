...
class ProductTemplate(models.Model):
    ...
    grimm_product_custom_product_template_id = fields.Many2one(string='Custom Product Template', related='variant_id.grimm_product_custom_product_template_id', readonly=False, copy=True)
...
class ProductProduct(models.Model):
    ...
    grimm_product_custom_product_template_id = fields.Many2one('grimm_custom_product.template', 'Template', copy=True)