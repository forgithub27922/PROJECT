...
class MagentoOrderShipmentExporter(Component):
    """ Export invoices to Magento """
    _name = 'magento.order.shipment.exporter'
    _inherit = 'magento.exporter'
    _apply_on = ['magento.order.shipment']

    def _export_shipment(self, magento_id, lines_info, mail_notification):
    ...
    def _get_lines_info(self, invoice):
        ...
        """
        item_qty = {}
        # get product and quantities to shipment
    ...
    def run(self, binding):
        ...
        magento_id = None
        try:
            magento_id = self._export_shipment(magento_order.magento_id,
                                               lines_info,
                                               mail_notification)
            ...
            if err.faultCode == 102:
                ...
                magento_id = self._get_existing_shipment(magento_order)
    ...
    def _get_existing_shipment(self, magento_order):
