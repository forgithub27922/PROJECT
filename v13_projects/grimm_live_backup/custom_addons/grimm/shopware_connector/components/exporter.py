...
class ShopwareBaseExporter(AbstractComponent):
    """ Base exporter for Shopware """

    _name = 'shopware.base.exporter'
    _inherit = ['base.exporter', 'base.shopware.connector']
    _usage = 'record.exporter'

    def __init__(self, working_context):
        super(ShopwareBaseExporter, self).__init__(working_context)
        self.binding = None
    ...
    def run(self, binding, *args, **kwargs):
        ...
        self.shopware_id = self.binder.to_external(self.binding)
        ...
        self.binder.bind(self.shopware_id, self.binding)
...
class ShopwareExporter(AbstractComponent):
    """ A common flow for the exports to Shopware """

    _name = 'shopware.exporter'
    _inherit = 'shopware.base.exporter'

    def __init__(self, working_context):
        super(ShopwareExporter, self).__init__(working_context)
        self.binding = None
