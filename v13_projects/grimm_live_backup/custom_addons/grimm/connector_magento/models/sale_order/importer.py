...
class SaleOrderBatchImporter(Component):
    ...
    def _import_record(self, magento_id, job_options=None, **kwargs):
        ...
        return super(SaleOrderBatchImporter, self)._import_record(
            magento_id, job_options=job_options)
    ...
    def run(self, filters=None):
        ...
        magento_ids = self.backend_adapter.search(
            filters,
            from_date=from_date,
            to_date=to_date,
        ...
        for magento_id in magento_ids:
            self._import_record(magento_id)
...
class SaleOrderImporter(Component):
    ...
    def _must_skip(self):
        ...
        """
        if self.binder.to_internal(self.magento_id):
    ...
    def _create(self, data):
        ...
        if binding.fiscal_position_id:
            binding.openerp_id._compute_tax_id()
        return binding
    ...
    def _import_addresses(self):
        ...
        if is_guest_order:
            ...
            map_record = addr_mapper.map_record(record['billing_address'])
            customer_record = map_record.values()
