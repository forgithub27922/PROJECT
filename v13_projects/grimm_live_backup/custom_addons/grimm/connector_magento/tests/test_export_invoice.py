...
class TestExportInvoice(MagentoSyncTestCase):
    ...
    def setUp(self):
        ...
        self.order_binding.openerp_id.action_confirm()
        invoice_ids = self.order_binding.openerp_id.action_invoice_create()
        assert invoice_ids
        self.invoice_model = self.env['account.move'] #odoo13change
