...
class MagentoImporter(AbstractComponent):
    ...
    def _import_dependency(self, magento_id, binding_model,
        ...
        if always or not binder.to_internal(magento_id):
            if importer is None:
            ...
            try:
                ...
                _logger.info(
                    ...
                    binding_model._name, magento_id
                )
...
class BatchImporter(AbstractComponent):
    ...
    def _import_record(self, magento_id):
...
class DirectBatchImporter(AbstractComponent):
    ...
    def _import_record(self, magento_id):
        ...
        self.model.import_record(self.backend_record, magento_id)
...
class DelayedBatchImporter(AbstractComponent):
    ...
    def _import_record(self, magento_id, job_options=None, **kwargs):
        """ Delay the import of the records"""
        delayable = self.model.with_delay(**job_options or {})
        delayable.import_record(self.backend_record, magento_id, **kwargs)
...
class TranslationImporter(Component):
    ...
    def run(self, magento_id, binding, mapper=None):
        self.magento_id = magento_id
