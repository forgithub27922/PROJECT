...
class PartnerExportMapper(Component):
    _name = 'shopware6.res.partner.export.mapper'
...
class ResPartnerExporter(Component):
    _name = 'shopware6.res.partner.exporter'
...
class ResPartnerDeleter(Component):
    _name = 'shopware6.res.partner.exporter.deleter'
    _inherit = 'shopware6.exporter.deleter'
    _apply_on = ['shopware6.res.partner']
    _usage = 'record.exporter.deleter'

class Shopware6PartnerListener(Component):
    _name = 'shopware6.binding.res.partner.listener'
...
class SupplierExportMapper(Component):
    _name = 'shopware6.supplier.export.mapper'
    _inherit = 'shopware6.export.mapper'
...
class SupplierExporter(Component):
    _name = 'shopware6.supplier.exporter'
    _inherit = 'shopware6.exporter'
    _apply_on = ['shopware6.supplier']
    _usage = 'record.exporter'

class SupplierDeleter(Component):
    _name = 'shopware6.supplier.exporter.deleter'
    _inherit = 'shopware6.exporter.deleter'
    _apply_on = ['shopware6.supplier']
    _usage = 'record.exporter.deleter'

class ShopwareSupplierListener(Component):
    _name = 'shopware6.binding.supplier.listener'
    _inherit = 'base.connector.listener'
    _apply_on = ['shopware6.supplier']
