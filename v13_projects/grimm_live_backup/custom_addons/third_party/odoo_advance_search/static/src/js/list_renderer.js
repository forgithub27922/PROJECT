odoo.define('odoo_advance_search.Listrenderer', function(require) {
    ...
    ListRenderer.include({
        ...
        setRowMode: function(recordID, mode) {
            var self = this;
            var res = this._super(recordID, mode)
        ...
        _renderBody: function() {
            ...
            if (this.getParent().hasSidebar && this.hasHandle && this.currentRow !== null && this.isEditable()) {
                this.currentRow = this.currentRow - 1;
            }
            return $body;
        },
        _selectCell: function(rowIndex, fieldIndex, options) {
            if (this.getParent().hasSidebar && this.isEditable() && rowIndex > 0) {
                rowIndex = rowIndex - 1
            }
        ...
        _renderHeader: function(isGrouped) {
            ...
            if ((this.getParent().hasSidebar && self.getParent()._controlPanel) || initial_view === 'search') {
                var context = {}
                if (self.getParent().searchView !== undefined && self.getParent().searchView.dataset) {
                    context = pyUtils.eval('contexts', [self.getParent().searchView.dataset.get_context()]);
...
//                                field_value_to = ''
//                            }
//                            column.date_from_widget = new datepicker.DateWidget(column, {
//                                defaultDate: field_value_from
//                            });
//                            column.date_to_widget = new datepicker.DateWidget(column, {
//                                defaultDate: field_value_to
//                            });
//                            var $wrapper = $("<div>", {});
...
//                            });
//                        } else {
//                            column.date_widget = new datepicker.DateWidget(column, {
//                                defaultDate: field_value || null
//                            });
//                            var $wrapper = $("<div>", {});
...
//                        var $input = $wrapper;
        ...
        onchangeDatetimeSearch: function(column) {
            ...
            try {
                this.trigger_up('search', odoo.odoo_web_client.action_manager.getCurrentController().widget._controlPanel.getSearchQuery());
            } catch (e) {
