...
class VehicleReportByVehicle(models.AbstractModel):

    _name='report.fleet_transactions.vehicle_report_by_vehicle'
    ...
    def get_report_values(self, docids, data=None):
        ...
        domain = [
            ('vehicle_id', '=', data['form'][0]['vehicle_id'][0]),
        ]
        ...
        return {
            ...
            'docs': docs,
            'txns': txns,
            'vehicle': data['form'][0]['vehicle_id'][1],
