...
class Machine(models.Model):
    ...
    def update_attribute(self):
        """
        This method will use for Update Attribute API
        ---------------------------------------------
    ...
    def machine_route_check(self):
        """
        This method will use for Route check API
        ---------------------------------------------
        @param self: object pointer
        """
        # TODO: API to be added
    ...
    def get_status_info(self):
        """
        This method will use for GetStationInfo API
        ---------------------------------------------
        @param self: object pointer
        """
        # TODO: API to be added
            ...
            if fl.endswith('.xml'):
                ...
                try:
                    for line in lines_lst:
                        # Process lines
                        if line[0] not in create_unit_vals.keys():
                            create_unit_vals[line[0]] = {
                                'Program': line[6],
                        ...
                        if line[1]:
                            if create_unit_vals[line[0]]['Units'][0].get('SubUnits', False):
                                create_unit_vals[line[0]]['Units'][0]['SubUnits'] = [
                                    {
                                        'RefNumber': "1",
                                        'Barcode': line[1],
                                        'Quality': line[5] == "P" and "Pass" or "Fail"
