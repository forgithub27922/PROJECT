...
class Machine(models.Model):
    ...
    failure_path = fields.Char('Failure Path',
                               help='In case of error while parsing the file will be moved to this directory')
            ...
            if fl.endswith('.xml'):
                ...
                try:
                    for line in lines_lst:
                        ...
                        print("DATA COLLEC", data_collection_vals)
        ...
        for fl in files:
            ...
            if fl.endswith('.xml') or fl.endswith('.XML'):
                ...
                def parse_xml(dm):
                    ...
                    if dm.getparent() and dm.getparent().tag == 'Board':
                        if dm.tag == 'MasterBarcode':
                            ...
                            print("PANEL", panel_barcode[0], type(panel_barcode))
                            dc_vals.update({
                                'Barcode': panel_barcode[0],
                                'StationBoardName': 'SOLDERPASTEINSPECTION',
                            })
                ...
                try:
                    ...
                    print("EDFEF", defect_collection_vals)
        ...
        for fl in files:
            ...
            if fl.endswith('.xml'):
                ...
                try:
                    ...
                    print("DATA C", data_collection_vals)
    ...
    def demo_machine(self, files, process_dir, success_dir, failure_dir):
        """
